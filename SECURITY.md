...
O cadastro exige aceite explícito da Política de Privacidade e dos Termos de Uso em `data-policy.html`. A aplicação registra a versão e a data do aceite no perfil. Esse texto é uma base técnica e deve ser revisado por profissional jurídico antes de uso público.
